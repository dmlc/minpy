...
class ThreeLayerConvNet(object):
  ...
  """
    ...
    """
        ...
        Hc, Wc = 1 + (H + 2 * conv_pad - filter_height) / conv_stride, 1 + (
            W + 2 * conv_pad - filter_width) / conv_stride
    ...
    """
        ...
        conv_out, conv_cache = conv_relu_pool_forward(X, W1, b1, conv_param,
                                                      pool_param)
